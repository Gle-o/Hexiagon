 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.gleo.plugins.hexiagon.model.AnnouncementModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link AnnouncementImpl}.
 * </p>
 *
 * @author guillaumelenoir
 * @see AnnouncementImpl
 * @see com.gleo.plugins.hexiagon.model.Announcement
 * @see com.gleo.plugins.hexiagon.model.AnnouncementModel
 * @generated
 */
@JSON(strict = true)
public class AnnouncementModelImpl extends BaseModelImpl<Announcement>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a announcement model instance should use the {@link com.gleo.plugins.hexiagon.model.Announcement} interface instead.
     */
