...
public abstract class FavoriteLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements FavoriteLocalService, IdentifiableBean {
    ...
    @Override
    public Favorite addFavorite(Favorite favorite) throws SystemException {
    ...
    @Override
    public Favorite deleteFavorite(long favoriteId)
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Favorite deleteFavorite(Favorite favorite) throws SystemException {
    ...
    @Override
    public Favorite fetchFavorite(long favoriteId) throws SystemException {
     ...
     */
    @Override
    public int getFavoritesCount() throws SystemException {
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Favorite updateFavorite(Favorite favorite) throws SystemException {
        return favoritePersistence.update(favorite);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.gleo.plugins.hexiagon.model.Favorite",
