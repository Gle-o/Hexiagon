 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.gleo.plugins.hexiagon.model.CurrencyModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CurrencyImpl}.
 * </p>
 *
 * @author guillaumelenoir
 * @see CurrencyImpl
 * @see com.gleo.plugins.hexiagon.model.Currency
 * @see com.gleo.plugins.hexiagon.model.CurrencyModel
 * @generated
 */
@JSON(strict = true)
public class CurrencyModelImpl extends BaseModelImpl<Currency>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a currency model instance should use the {@link com.gleo.plugins.hexiagon.model.Currency} interface instead.
     */
